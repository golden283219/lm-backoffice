            ...
            'format' => function ($value) {
                switch ($value) {
                    ...
                    case \yii\log\Logger::LEVEL_WARNING:
                        return '<span class="badge bg-yellow">WARNING</span>';
                        break;
                    case \yii\log\Logger::LEVEL_INFO:
                        return '<span class="badge bg-light-blue">INFO</span>';
                        break;
                    case \yii\log\Logger::LEVEL_TRACE:
                        return '<span class="badge bg-green">TRACE</span>';
                        break;
                    default:
                        return '<span class=\'badge\'>' . strtoupper(\yii\log\Logger::getLevelName($value)) . '</span>';
                        break;
                }
            },
            'filter' => [
