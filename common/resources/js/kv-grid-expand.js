    ...
    kvExpandRow = function (options, id) {
        ...
        ToggleManager.prototype = {
            ...
            init: function () {
                ...
                $(document).on('data-grid-reload-cell', function (event, vKey) {
            ...
            load: function (postProcess, ignoreCache) {
                ignoreCache = typeof (ignoreCache) === 'undefined' ? false : ignoreCache;
                var self = this, $cell = self.$cell, $detail = self.$detail, vKey = self.vKey, vInd = self.vInd,
                    ...
                    reload = enableCache && !ignoreCache ? $detail.html().length === 0 : true;
